...
public class Admin_CreateEmployee {
	...
	public Admin_CreateEmployee() {
		...
		*/
		...
		lempID.setBackground(Employee_HomePage.mygrey);
			...
			public void actionPerformed(ActionEvent ae) {
				...
				if(validateForm()) {
					...
					if (gender.equals("M") || gender.equals("F")) {
						...
						JOptionPane.showMessageDialog(f5,  "Gender should be M or F", 
	...
	private boolean validateForm() {
		if(((tName.getText().length())==0)||((tGender.getText().length())==0)||((tAge.getText().length())==0)
	...
	public boolean createRecord() 
	{
		...
		return aH.AddEmployee(employeeID, employeeName, employeePassword, cnic, age, gender, employeeAddress, joinDate, nation, phone, passport);
	}
}